...
When code is altered, a PR is necessary no matter how minor. There are some rules as to how long a PR can "hang" however before being merged. If the reviewer is not active in the process than group leader can merge a PR within a week i.e they take over on the PR review. In circumstances when the reviewer is active we expect a turn around as follows:
