...
def plotmom_fit(mom_mag,mc_count, fit_range, list_pdfs, cat=None):
    ...
    if cat is not None:
        ...
        labs_true = ['Cosmic','iRPC','eRPC','IPA DIO','Trgt DIO', ' Signal']
        datasets_filled = []
        colors_filled = []
        labels_filled = []
...
def plottime_fit(time,mc_count, fit_range, list_pdfs, cat=None):
    ...
    if cat is not None:
        ...
        labs_true = ['Cosmic','iRPC','eRPC','IPA DIO',"iRMC","eRMC",'Trgt DIO', ' Signal']
        datasets_filled = []
        colors_filled = []
        labels_filled = []
        for i, dat in enumerate(datasets):
